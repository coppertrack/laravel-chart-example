...
/* harmony import */ var _components_chart__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/chart */ "./resources/js/components/chart.js");
...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('chart', _components_chart__WEBPACK_IMPORTED_MODULE_1__.chart);
...
function chart(data, type) {
  return {
    init: function init() {
      new chart_js__WEBPACK_IMPORTED_MODULE_0__.Chart(this.$refs.chart, {
        type: type,
        data: data
      });
    }
